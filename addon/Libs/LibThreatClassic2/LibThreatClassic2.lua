...
------------------------------------------------------------------------
function ThreatLib:UnitGUIDDetailedThreatSituation(unitGUID, targetGUID, targetTargetGUID)
...
function ThreatLib:UnitDetailedThreatSituation(unit, target)
	...
	print("Tacos")
	return self:UnitGUIDDetailedThreatSituation(unitGUID,targetGUID, targetTargetGUID)
end
